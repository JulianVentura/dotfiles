...
keymap.set("n", "<leader>fs", "<cmd>Telescope current_buffer_fuzzy_find<cr>") -- find string in current buffer as you type
...
keymap.set("n", "<leader>fd", "<cmd>Telescope diagnostics<cr>") -- list references
